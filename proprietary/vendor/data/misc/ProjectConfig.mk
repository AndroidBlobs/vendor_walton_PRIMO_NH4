...
CUSTOM_MODEM = x6332_g4_w1258_hspa
...
# LCM
BOOT_LOGO = x6332_walton_80_o1_go_fwvgaplus
...
# CAMERA:=============
CUSTOM_HAL_IMGSENSOR = gc5025_mipi_raw gc23850_mipi_raw gc8034_mipi_raw gc50250_mipi_raw gc8034cxt_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = gc5025_mipi_raw gc8034_mipi_raw gc8034cxt_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_IMGSENSOR = gc23850_mipi_raw gc50250_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = 
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =

CUSTOM_KERNEL_IMGSENSOR = gc5025_mipi_raw gc23850_mipi_raw gc8034_mipi_raw gc50250_mipi_raw gc8034cxt_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5025_mipi_raw gc8034_mipi_raw gc8034cxt_mipi_raw
...
WTK_MTP_LABEL = PRIMO NH4
WTK_PTP_LABEL = PRIMO NH4
WTK_INTERNAL_SD_LABEL = PRIMO NH4
#add by gaoshan 20180122 end

#add by liutao  20180122 start
WTK_TARGET_BOARD_NAME = WALTON
#add by liutao 20180122 end

# A: Bug_id:add WtkCamera chenchunyong 20190312 {
WTK_CAMERA_SUPPORT = yes
# A: }

#A:by wuzhi.peng for XLSSW-11 start
WTK_DEFAULT_BLUETOOTH_NAME = PRIMO NH4
#A:by wuzhi.peng for XLSSW-11 end

# Add Screen cornner design begin
WTK_SCREEN_CORNER_SUPPORT = no
# Add Screen cornner design end

#add adupsfota by gaoshan start
ADUPS_FOTA_SUPPORT=yes
ADUPS_FOTA_WITH_ICON=no
ADUPS_FOTA_WITHOUT_MENU=no
#add adupsfota by gaoshan end

# A: Bug_id:TRACKSYS-4131 chenchunyong 20190321 {
...
# add BUG_ID:XLSSE-1140 zhangzhanbo 20190320
WTK_SMART_NAVIBAR_SUPPORT = yes

WTK_MULTISIM_RINGTONE_SUPPORT = yes
# A: XLSSE-1124 jinhui.li start {
WTK_PHOTOS_OVERRIDES_GALLERY2 = yes
# A: XLSSE-1124 jinhui.li end }


# A: by liutao  for XLSSE-1235 20190413 start{
FACTORY_RES_OVERRIDES = yes
# A: by liutao  for XLSSE-1235 20190413 end }
